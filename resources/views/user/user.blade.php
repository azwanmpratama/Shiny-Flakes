                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link waves-effect waves-dark sidebar-link" href="user"
                                    aria-expanded="false"><i class="mdi mdi-skull" style="color: #3f51b5;"></i><span
                                        class="hide-menu" style="font-weight: 550;">User</span></a>
                            </li>
                            <li class="sidebar-item">
                            ...
                            <div class="card-body">
                                <div class="col-12">
                                    <div class="text-end upgrade-btn">
                                        <button type="button" class="btn btn-primary text-white mdi mdi-account-plus"
                                        data-bs-toggle="modal" data-bs-target="#staticBackdrop" target="_blank"
                                        data-bs-toggle="tooltip" data-bs-placement="left" title="Add User"
                                        id="tooltipBtn" style="border-radius: 100px">
                                        </button>
                                        <!-- Modal -->
                                            ...
                                            <div class="modal-dialog">
                                              <div class="modal-content" style="border-radius: 10px;">
                                                ...
                                                <div class="modal-body">
                                                    <div class="row g-3 mb-4">
                                                        <div class="col-md-6 mb-3">
                                                            <label for="nama_user" >Username <span style="color: #3f51b5;">*</span> </label><br>
                                                            <input onmouseover="addStroke1(this)" onmouseout="removeStroke1(this)" onclick="addShadow1(this)" onblur="removeShadow1(this)" tabindex="0" type="text" class="form-control" aria-label="Nama Produk" style="border-radius: 10px;">
                                                            <script>
                                                        ...
                                                        <div class="col-md-6 mb-3">
                                                            <label for="password">Password <span style="color: #3f51b5;">*</span> </label><br>
                                                            <input onmouseover="addStroke2(this)" onmouseout="removeStroke2(this)" onclick="addShadow2(this)" onblur="removeShadow2(this)" tabindex="0" type="text" class="form-control" aria-label="Harga" id="harga" oninput="formatHarga(event)" style="border-radius: 10px;">
                                                            <script>
                                                    ...
                                                    <div class="row g-3">
                                                        <div class="col-md-6 mb-4">
                                                            <label for="email">Email <span style="color: #3f51b5;">*</span> </label><br>
                                                            <input onmouseover="addStroke3(this)" onmouseout="removeStroke3(this)" onclick="addShadow3(this)" onblur="removeShadow3(this)" tabindex="0" type="text" class="form-control" aria-label="Berat" id="beratInput" oninput="formatBerat(event)" style="border-radius: 10px;">
                                                            <script>
                                                        ...
                                                        <div class="col-md-6 mb-3">
                                                            <label for="role_user">Role <span style="color: #3f51b5;">*</span></label><br>
                                                            <select class="form-select" aria-label="Default select example" onmouseover="addStroke4(this)" onmouseout="removeStroke4(this)" onclick="addShadow4(this)" onblur="removeShadow4(this)" tabindex="0" id="role_user" class="form-control" aria-label="Role" style="border-radius: 10px;">
                                                            <option selected disabled hidden>Choose your role, bitch </option>
                                                ...
                                                <div class="modal-footer">
                                                  <button type="button" class="btn btn-danger" data-bs-dismiss="modal" style="border-radius: 10px;">Cancel</button>
                                                  <button type="button" class="btn btn-primary" style="border-radius: 10px;">Save</button>
                                                </div>
                                              </div>
                                            </div>
                                          </div>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>cawan@tomsketer.dot</td>
                                            <td>cawan</td>
                                            <td>Admin</td>
                                            <td></td>
                                            <td><button type="button"
                                                    class="btn btn-outline-warning mx-3">Edit</button></td>
                                            <td><button type="button" class="btn btn-outline-danger mx-3">Delete</td>
                                        </tr>
                                        <tr>
